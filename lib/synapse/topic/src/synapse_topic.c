...
void topic_work_handler(struct k_work* work)
{
    ...
    } else if (topic == &topic_angular_velocity_sp || topic == &topic_attitude_sp || topic == &topic_moment_sp || topic == &topic_force_sp || topic == &topic_velocity_sp || topic == &topic_orientation_sp) {
