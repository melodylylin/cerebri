...
/* quaternion_to_euler:(yaw,pitch,roll)->(q_wb[4]) */
...
casadi_int quaternion_to_euler_n_in(void) { return 3; }
...
/* position_control:(m,pt_w[3],vt_w[3],at_w[3],yt,Kp,Kv,p_w[3],v_b[3],q_wb[4])->(nT,euler[3]) */
static int casadi_f3(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem)
{
    ...
    w[8] = casadi_sq(w[7]);
    w[9] = (w[6] + w[8]);
    w[10] = arg[9] ? arg[9][2] : 0;
    w[11] = casadi_sq(w[10]);
    w[9] = (w[9] - w[11]);
    w[12] = arg[9] ? arg[9][3] : 0;
    w[13] = casadi_sq(w[12]);
    w[9] = (w[9] - w[13]);
    w[14] = arg[8] ? arg[8][0] : 0;
    w[9] = (w[9] * w[14]);
    w[15] = 2.;
    w[16] = (w[7] * w[10]);
    w[17] = (w[5] * w[12]);
    ...
    w[21] = (w[18] + w[20]);
    w[21] = (w[15] * w[21]);
    w[22] = arg[8] ? arg[8][2] : 0;
    w[21] = (w[21] * w[22]);
    w[9] = (w[9] + w[21]);
    w[21] = arg[2] ? arg[2][0] : 0;
    w[9] = (w[9] - w[21]);
    w[9] = (w[4] * w[9]);
    w[3] = (w[3] + w[9]);
    w[1] = (w[1] - w[3]);
    ...
    w[9] = arg[3] ? arg[3][1] : 0;
    w[9] = (w[0] * w[9]);
    w[21] = arg[7] ? arg[7][1] : 0;
    w[23] = arg[1] ? arg[1][1] : 0;
    w[21] = (w[21] - w[23]);
    w[21] = (w[2] * w[21]);
    w[16] = (w[16] + w[17]);
    w[16] = (w[15] * w[16]);
    ...
    w[21] = casadi_sq(w[9]);
    w[3] = (w[3] + w[21]);
    w[21] = 9.8000000000000007e+00;
    w[16] = arg[7] ? arg[7][2] : 0;
    w[7] = arg[1] ? arg[1][2] : 0;
    w[16] = (w[16] - w[7]);
    w[2] = (w[2] * w[16]);
    w[18] = (w[18] - w[20]);
...
casadi_int position_control_n_in(void) { return 10; }
...
{
    if (sz_arg)
        *sz_arg = 10 * sizeof(const casadi_real*);
    if (sz_res)
        *sz_res = 2 * sizeof(casadi_real*);
    if (sz_iw)
        *sz_iw = 0 * sizeof(casadi_int);
    if (sz_w)
        *sz_w = 24 * sizeof(casadi_real);
    return 0;
}
