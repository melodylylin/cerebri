...
#else
  #define CASADI_PREFIX(ID) melm_ ## ID
#endif
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[9]=(w[9]*w[6]);
  w[1]=(w[1]-w[9]);
  if (res[0]!=0) res[0][3]=w[1];
  w[8]=(w[8]/w[7]);
  w[4]=(w[4]*w[6]);
  w[8]=(w[8]-w[4]);
  if (res[0]!=0) res[0][4]=w[8];
  if (res[0]!=0) res[0][5]=w[6];
  return 0;
}
...
static int casadi_f2(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[11]=(w[11]+w[17]);
  w[17]=atan2(w[7],w[11]);
  if (res[2]!=0) res[2][0]=w[17];
  w[17]=casadi_sq(w[11]);
  w[15]=casadi_sq(w[7]);
  w[17]=(w[17]+w[15]);
  w[15]=sqrt(w[17]);
  if (res[3]!=0) res[3][0]=w[15];
  w[15]=4.;
  w[5]=(w[9]-w[5]);
  w[5]=(w[15]*w[5]);
  w[5]=(w[5]/w[3]);
...
static int casadi_f4(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[2]=(w[1]/w[5]);
  if (res[0]!=0) res[0][1]=w[2];
  w[9]=0.;
  if (res[0]!=0) res[0][2]=w[9];
  w[2]=(-w[2]);
  if (res[0]!=0) res[0][3]=w[2];
  if (res[0]!=0) res[0][4]=w[4];
  if (res[0]!=0) res[0][5]=w[9];
  w[9]=casadi_fabs(w[1]);
  w[9]=(w[0]<w[9]);
  w[4]=arg[0]? arg[0][0] : 0;
  w[2]=(w[1]*w[4]);
  ...
  w[0]=(w[0]?w[4]:0);
  w[2]=(w[2]+w[0]);
  if (res[0]!=0) res[0][7]=w[2];
  if (res[0]!=0) res[0][8]=w[8];
  return 0;
}
...
static int casadi_f5(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[2]=0.;
  if (res[0]!=0) res[0][2]=w[2];
  w[8]=(-w[8]);
  if (res[0]!=0) res[0][3]=w[8];
  w[4]=(-w[4]);
  if (res[0]!=0) res[0][4]=w[4];
  if (res[0]!=0) res[0][5]=w[2];
  w[2]=casadi_fabs(w[1]);
  w[2]=(w[0]<w[2]);
  w[4]=arg[0]? arg[0][0] : 0;
  w[8]=(w[1]*w[6]);
